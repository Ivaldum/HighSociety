...
</p> <div class="grid grid-cols-2 my-8 sm:grid-cols-2 lg:grid-cols-4 gap-x-2 gap-y-2 md:gap-x-8 md:gap-y-8"> ${renderComponent($$result, "DjsCard", $$DjsCard, { "name": "Gonza Paltenghi", "location": "Rosario del tala", "instagram": "https://www.instagram.com/GonzaPaltenghi", "image": "/my-repo/GonzaPaltenghi.png" })} ${renderComponent($$result, "DjsCard", $$DjsCard, { "name": "Rodrigo Veit", "location": "Macia", "instagram": "https://www.instagram.com/rodrigo_veit", "image": "/my-repo/RodrigoVeit.png" })} ${renderComponent($$result, "DjsCard", $$DjsCard, { "name": "Copy Legaria", "location": "Urdinarrain", "instagram": "https://www.instagram.com/copylegaria", "image": "/my-repo/CopyLegaria.png" })} ${renderComponent($$result, "DjsCard", $$DjsCard, { "name": "Mateo Bosc", "location": "Macia", "instagram": "https://www.instagram.com/mateobosc__", "image": "/my-repo/MateoBosc.png" })} ${renderComponent($$result, "DjsCard", $$DjsCard, { "name": "Joaquin Castillo", "location": "Basavilbaso", "instagram": "https://www.instagram.com/joaquiincastillo", "image": "/my-repo/JoaquinCastillo.png" })} ${renderComponent($$result, "DjsCard", $$DjsCard, { "name": "Paolo Maffei", "location": "Concepcion del Uruguay", "instagram": "https://www.instagram.com/paolomaffei_", "image": "/my-repo/PaoloMaffei.png" })} ${renderComponent($$result, "DjsCard", $$DjsCard, { "name": "\u{1F512}", "location": "Secret Location", "instagram": "", "image": "" })} ${renderComponent($$result, "DjsCard", $$DjsCard, { "name": "\u{1F512}", "location": "Secret Location", "instagram": "", "image": "" })} </div> </section>`;
...
Nos caracterizamos por realizar eventos unicos
        ...
        \u{1F3D6}\uFE0FEl verano es al aire libre, y con High\u{1F576}\uFE0F.`, "instagram": "https://www.instagram.com/summer.club____/", "image": "/my-repo/summerclub.jpg" })} ${renderComponent($$result, "EventosCard", $$EventosCard, { "title": "LA FINCA \u{1F3DB}\uFE0F", "description": `Es un para\xEDso que abre sus puertas en ocasiones especiales, FINDES XXL, por lo general .
      Un lugar totalmente misterioso, donde tanto los organizadores como los que concurren a los eventos firman un pacto de silencio, donde lo ocurrido en la noche no se vuelve a repetir ni contar \u{1F92B}.`, "instagram": "https://www.instagram.com/lafinca_____/", "image": "/my-repo/lafinca.jpg" })} ${renderComponent($$result, "EventosCard", $$EventosCard, { "title": "YOUNG \u{1F984}", "description": `Es un espacio donde todas las promos y sus invitados van a poder disfrutar una noche a lo High ; a su manera, a su gusto, como ellos kieran vamos a decirle.
      El fin de las estudiantinas es colaborar con la PROMO25 a recaudar fondos
      para el Baile de Recepci\xF3n 2024\u{1F498}.`, "instagram": "https://www.instagram.com/young.season_/", "image": "/my-repo/young.jpg" })} </div> </section>`;
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "High Society" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="px-4"> ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "nosotros", "class": "py-8 md:py-16" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Header", $$Header, {})} ` })} </main> <div> ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "djs" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "NextEvent", $$NextEvent, { "title": "Proximo evento", "description": "Flow 2000", "imageAlt": "imagen After club", "imageSrc": "/my-repo/flow2000.jpg", "button1Link": "http://www.instagram.com/highsociety.ar", "button2Link": "https://www.passline.com/eventos?q=high+society&region=&mes=&pais=argentina&page=1" })} ` })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "djs" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "NuestrosDjs", $$NuestrosDjs, {})} ` })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "eventos" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Eventos", $$Eventos, {})} ` })} ${renderComponent($$result2, "SectionContainer", $$SectionContainer, { "id": "spotify" }, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "SectionSpoty", $$SectionSpoty, {})} ` })} </div> ` })}`;
